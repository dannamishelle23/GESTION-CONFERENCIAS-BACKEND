...
router.post('/reservas/crear-reserva', verificarTokenJWT, autorizarConferencista, crearReserva)
//2. Listar todas las reservas - Admin y Cliente
router.get('/reservas/listar-reservas', verificarTokenJWT, autorizarAdminOConferencista, listarReservas)
